...
const messages = [
	...
	// 25.12
	["И снова рождественские чтения!🥳🥳🥳 Начинаем читать Письма Рождественского Деда авторства Толкина (1925-1928) и кушаем булочки с шоколадно-ореховой пастой"],
	// 26.12
	...
	// 28.12
	["Письма Рождественского Деда еще не окончены, поэтому читаем дальше(1933)☃️ и варим какао!"],
	// 29.12
