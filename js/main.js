...
const messages = [
	...
	// 15.12
	["Чем заняться в 11 часов вечера в воскресенье? Правильно - сходить поппить пивка в бар рядом с домом! Когда мы в последний раз так пиво пили?✨✨✨"],
	// 16.12
	...
	// 18.12
	["В этом году у нис в адвенте что ни ужин, так что-то необычное. Устроим сегодня сладкий стол!😋🍭"],
	// 19.12
	...
	// 21.12
	["Немного утешения от расставания с Валей сегодня, по уже полезного в быту😊"],
	// 22.12
	["В городе уже развесили фогоньки и поставили ёлки, которые так и ждут, чтобы мы сходили на них посмотреть😏 И заглянуть к католикам, конечно же⛪"],
	// 23.12
	...
	// 30.12
	["Дочитываем прекрасную рождественскую повесть и акатываем сногсшибательный ужин при свечах🕯️🕯️🕯️"],
	// 31.12
