...
const messages = [
	...
	// 22.12
	["Для того, чтобы помнить свои дела, нужно куда-то их записывать, поэтому Дедушка Морроуз принес для Юры очень нужный для этого подарок📗. А вечером можно напечь ароматных динозавров 🦕 и посмотреть фильм Щелкунчик и четыре королевства👀"],
	// 23.12
	...
	// 25.12
	["Что может быть лучше теплого пряного глинтвейна, да еще и во время игры в настольные танки?🍷🍷🍷 А вечером - душевнейший фильм Все мы из Бюллербю, 1 часть"],
	// 26.12
	["Дед Морроуз велит проследить за католиками - что у них там в костеле происходит интересное⛪, после этого погулять на ярмарке в городе🎊☕ и посмотреть вторую часть Все мы из Бюллербю"],
	// 27.12
	["Устравиаем рождественские чтения!🥳🥳🥳 Читаем Рождественскую песнь в прозе Чарльза Диккенса (1 и 2 часть), смотрим фильм Рождественское приключение Бетховена🎆"],
	// 28.12
	...
	// 01.01
	["Сегодня самый тихий день года, потому что все спят полдня😂 Наступил Новый год - какими мы будем в нем, какими будут наши мечты и стремления?🤔 Очень важно, чтобы у нас они в принципе были❤️❤️❤️ Юра, а у Деда Морроуза припасен для тебя последний подарочек🥰"]
];
